...
**Hackathon Track Record** — Active on DoraHacks, Stellar Hacks (Turing Agents), FlagOS Open Computing (Auto Data Annotation), AI Trading Agents ($55K pool). Hackathons as forcing functions for shipping production-grade prototypes under pressure, not weekend toys.
...
| :--- | :--- | :--- |
| **Turing Arbitrage Mesh** | TypeScript, Next.js, Soroban, WASM | [Live](https://turing-arbitrage-mesh.vercel.app) |
...
◆ [Turing Sovereign Gateway](https://turing-arbitrage-mesh.vercel.app) — live agent mesh with real-time dashboard
