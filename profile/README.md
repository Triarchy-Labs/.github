...
| :--- | :--- | :--- |
| **[`x402-arbitrage-mesh`](https://github.com/Stellar-Agent-Labs/x402-arbitrage-mesh)** | Centralized Swarm Gateway | Soroban routing, Treasury Logic |
| **[`farcaster-token-gate`](https://github.com/Stellar-Agent-Labs/farcaster-token-gate)** | Decentralized Identity | Multi-Agent verification protocols |
